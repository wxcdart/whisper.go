...
#
# Source: https://github.com/ggerganov/whisper.cpp/blob/master/models/download-ggml-model.sh
# Backup script - use cmd/download-model (Go utility) as the primary downloader
